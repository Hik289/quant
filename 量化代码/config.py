...
opt_des_path= output_path  ###save统计指标的excel
'''
dir_path='/usr/datashare/wufei/other_factor'
risk_path ='/usr/datashare/wufei/risk_factor'
other_factor_path =dir_path
alpha_path='/usr/datashare/wufei/risk_factor/alpha'
output_path='/usr/datashare/wufei/alpha_test'
summary_path = output_path
draw_picture_path = output_path
multifactor_des_path= output_path #save residual list path
opt_des_path= output_path  ###save统计指标的excel
